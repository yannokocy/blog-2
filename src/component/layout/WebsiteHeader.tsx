...
export function WebsiteHeader() {
  return (
    <header className="w-full h-20 bg-green-900 py-5 text-gray-950 px-6 flex items-center justify-between">
      {/* Titre */}
      ...
      <div className="flex gap-4">
        ...
        <Link href="/auth/login">
          <Button
            title="login"
            type="button"
            className="bg-blue-500 hover:bg-blue-600 pt-2 py-3 px-4 mt-3 rounded text-white"
            onClick={undefined}
          />
        </Link>
        <Link href="/auth/sign-up">
          <Button
            title="sign up"
            type="button"
            className="bg-green-500 hover:bg-green-600 pt-2 py-3 px-4 mt-3 rounded text-white"
            onClick={undefined}
          />
        </Link>
      </div>
